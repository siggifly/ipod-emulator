...
//
//   - `Row::CheckUpdates` is **1** — `drawer.slint:474`, `root.setting-toggled(1)`.
//   - `Row::CopyPath` is **2** — `drawer.slint:477`, `root.setting-toggled(2)`.
//
...
mod tests {
    ...
    /// **No disabled row carries an empty reason** — `primitives.slint:526`'s own words,
