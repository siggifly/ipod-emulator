...
warm-entry recipes, which by construction have no bootloader. **The fifth row, #17, left this table
on 2026-08-19** — its two flags were deleted rather than merely switched off, so there is nothing
left to be off by default.
