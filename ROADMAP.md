...
| Rockbox 4.0 | **boots to its main menu and takes wheel input** (2026-08-18), and **cold-boots to it** through Apple's bootloader and its own (2026-08-19) — same 10 304 ATA commands and 74 057 lit pixels with one core or two. Doom **passes the boot matrix on all three ROM/drive pairs** (2026-09-05) — 29 pictures, 30 of 30 script steps, reached by shortcut from Rockbox's own menu; the three assets it needs are now installed by the harness instead of demanded of a hand-prepared drive. No sound |
